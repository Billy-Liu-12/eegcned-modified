...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_file', default='E:\\eegcned\\data_doc\\train.txt')
    parser.add_argument('--dev_file', default='E:\\eegcned\\data_doc\\dev.txt')
    parser.add_argument('--test_file', default='E:\\eegcned\\data_doc\\test.txt')

    # parser.add_argument('--train_file', default='/home/billyliu/eegcned/data_doc/train.txt')
    # parser.add_argument('--dev_file', default='/home/billyliu/eegcned/data_doc/dev.txt')
    # parser.add_argument('--test_file', default='/home/billyliu/eegcned/data_doc/test.txt')

    # parser.add_argument('--train_file', default='/home/billyliu/eegcned/data_doc/example.train')
    # parser.add_argument('--dev_file', default='/home/billyliu/eegcned/data_doc/example.dev')
    # parser.add_argument('--test_file', default='/home/billyliu/eegcned/data_doc/example.test')
