...
dep_dict = {'root': 0, 'punct': 1, 'iobj': 2, 'parataxis': 3, 'auxpass': 4, 'aux': 5,
            ...
            # , 'obl': 40, 'obj': 41,
            # 'obl:npmod': 42, 'fixed': 43, 'nsubj:pass': 44, 'aux:pass': 45, 'obl:tmod': 46,
            # 'csubj:pass': 47, 'orphan': 48, 'goeswith': 49}


# depdency feature number which is bigger than 39 is updated from the 4.2.0 version
